...
//        }
    ...
    func configure() {
        ...
        if post == nil{
            ...
            navigationItem.leftBarButtonItem = serviceButton
        }
    ...
    func cell(_ cell: FeedCell, didLike post: Post) {
        ...
        if post.didLike {
            ...
            PostService.unlikePost(post: post) { _ in
                cell.likeButton.setImage(#imageLiteral(resourceName: "pawLike"), for: .normal)
            ...
            PostService.likePost(post: post) { _ in
                cell.likeButton.setImage(#imageLiteral(resourceName: "pawLikeTapped"), for: .normal)
