...
class UploadPostController: UIViewController {
    ...
    private let characterCountingLabel: UILabel = {
        let label = UILabel()
    ...
    func configureUI() {
        ...
        view.addSubview(characterCountingLabel)
        characterCountingLabel.anchor(bottom: captionTextView.bottomAnchor, right: view.rightAnchor, paddingBottom: -8, paddingRight: 12)
    }
}
...
extension UploadPostController: UITextViewDelegate {
    func textViewDidChange(_ textView: UITextView) {
        ...
        characterCountingLabel.text = "\(count)/150"
    }
}
